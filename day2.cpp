#include </Users/akhil/Documents/Courses/Udemy/HackerRank_30DaysofCode/stdc++.h>
...
void solve(double meal_cost, int tip_percent, int tax_percent) {
    double tip_final = (meal_cost * tip_percent) /100;
    double tax_final = (meal_cost * tax_percent) /100;
    double total = meal_cost + tip_final + tax_final;
